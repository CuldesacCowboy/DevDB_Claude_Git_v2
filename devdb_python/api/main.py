...
from api.routers import developments, eg_crud, eg_validation, eg_views, instruments, lots, phases, tda_crud, tda_checkpoints, tda_assignments, tda_banks, site_plans, phase_boundaries, lot_positions, simulations, ledger, building_groups, global_settings, admin, bulk_lots, marks, overrides, delivery_events, ref_data, scenarios, portfolio
...
app.include_router(tda_banks.router)
...
app.include_router(bulk_lots.router)
