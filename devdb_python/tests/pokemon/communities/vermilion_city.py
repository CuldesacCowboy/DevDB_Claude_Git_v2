...
def install(conn) -> None:
    ...
    conn.execute(
        ...
        """,
        (7005, "Vermilion City SF", "QE", county_id, state_id, ENT_GROUP_ID),
    )
    ...
    conn.executemany_insert("sim_phase_product_splits", [
        {"phase_id": 70011, "lot_type_id": 101, "projected_count": 20},
        {"phase_id": 70012, "lot_type_id": 101, "projected_count": 20},
    ])
