...
export default function LotPhaseView({ selectedGroupId, setSelectedGroupId, showTestCommunities }) {
  // -----------------------------------------------------------------------
        ...
        <div style={{ width: 220, pointerEvents: sidebarOpen ? 'auto' : 'none' }} className="flex flex-col h-full">
          <div className="pt-10 px-3 pb-4 overflow-y-auto flex-1">
            ...
            {communities.length === 0 ? (
              ...
              communities.filter(c => showTestCommunities ? c.is_test : !c.is_test).map((c) => (
