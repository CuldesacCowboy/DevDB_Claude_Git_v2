...
| Phase dev_id repair | Complete | Migration 042: fixed sim_legal_instruments.dev_id and sim_dev_phases.dev_id for 37 instruments and ~73 phases. Migration 043: Abbey Farms restructure (5 instruments, 283 units, 4 new phases). Migration 044: rebuilt sim_ent_group_developments from authoritative community_id (deleted 106 wrong rows, inserted 105 correct). Migration 045: rederived sim_legal_instruments.dev_id via dim_development bridge (fixed 58 instruments using wrong ID space). |
