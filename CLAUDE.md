...
| Phase dev_id repair | Complete | Migration 042: fixed sim_legal_instruments.dev_id and sim_dev_phases.dev_id for 37 instruments and ~73 phases mis-assigned during original seeding. All phases now correctly linked to their development. |
